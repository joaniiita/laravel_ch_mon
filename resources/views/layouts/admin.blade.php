...
<div class="d-flex">
    ...
    <div class="sidebar d-flex flex-column p-0">
        ...
        <div class="p-4 border-bottom border-white border-opacity-25 text-center">
            <div class="mb-2 d-inline-flex align-items-center justify-content-center text-danger bg-white rounded-circle" style="width: 50px; height: 50px;">
        ...
        <div class="p-3">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link text-white py-2 active" style="background-color: rgba(0,0,0,0.1); border-left: 3px solid white;" href="#">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
            <div class="container-fluid">
                <form class="d-flex ms-3 me-auto" role="search">
                    <input class="form-control rounded-pill" type="search" placeholder="Search Here" aria-label="Search" style="width: 400px;">
                </form>
                ...
                <div class="d-flex align-items-center me-3">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="rounded-circle bg-light d-inline-block border border-2 border-secondary me-2" style="width: 35px; height: 35px;">
                        </div>
