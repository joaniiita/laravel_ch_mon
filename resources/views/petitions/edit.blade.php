                    ...
                    <div class="card card-body">
                        <form method="POST" action="{{route('petitions.update', $petition->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" required name="title" value="{{$petition->title}}">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" rows="10" id="descripcion" name="description" required>{{$petition->description}}</textarea>
                                @error('description')
                                <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="form-control" id="image" name="image" value="{{$petition->image}}">
                                @error('image')
                                <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
